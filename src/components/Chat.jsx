...
export  const MarkdownRenderer = ({ htmlContent, isLoading, isTakingLong }) => {
...
export const MessageMenu = ({ msg, index, onCopy, onShare, onDelete, onRegenerate, onDocxDownload }) => {
