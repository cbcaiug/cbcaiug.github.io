    ...
    return (
        <div className="w-full h-full flex items-start sm:items-center justify-center bg-white relative overflow-hidden font-sans p-4 pt-8 sm:pt-4">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] left-[-10%] w-48 h-48 bg-blue-50 rounded-full blur-3xl opacity-60"></div>
                <div className="absolute bottom-[-10%] right-[-10%] w-48 h-48 bg-purple-50 rounded-full blur-3xl opacity-60"></div>
            </div>
            ...
            <div className="relative bg-white rounded-2xl border border-gray-100 shadow-lg p-5 w-full max-w-md">
                ...
                <div className="flex justify-center mb-4">
                    <img
                        src="https://github.com/cbcaiug/cbcaiug.github.io/blob/968296ac78f5009dda57de96f6491dd4ed0e9fb5/images/cbc-ai-tool-logo%20FOR%20SOCIAL%20MEDIA%20FORMAT.jpeg?raw=true"
                        alt="CBC AI Logo"
                ...
                {/* Title */}
                <h1 className="text-lg font-bold text-gray-900 text-center mb-1">Welcome to CBC AI</h1>
                <p className="text-xs text-gray-500 text-center mb-4">Your AI partner for the new curriculum</p>
                ...
                <div className="space-y-2 mb-4">
                    <div className="flex items-center gap-3 p-2.5 rounded-lg bg-gray-50 border border-gray-100">
                        ...
                        <div>
                            <span className="text-sm font-medium text-gray-900">1. Select Tool</span>
                            <span className="text-xs text-gray-500 ml-1">— Choose from sidebar</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 p-2.5 rounded-lg bg-gray-50 border border-gray-100">
                        <div className="w-7 h-7 bg-purple-100 text-purple-600 rounded-md flex items-center justify-center shrink-0">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                        </div>
                        <div>
                            <span className="text-sm font-medium text-gray-900">2. Input Details</span>
                            <span className="text-xs text-gray-500 ml-1">— Attach docs, hit Send</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 p-2.5 rounded-lg bg-gray-50 border border-gray-100">
                        <div className="w-7 h-7 bg-green-100 text-green-600 rounded-md flex items-center justify-center shrink-0">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                        </div>
                        <div>
                            <span className="text-sm font-medium text-gray-900">3. Generate</span>
                            <span className="text-xs text-gray-500 ml-1">— Get NCDC results</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-center gap-3 pt-3 border-t border-gray-100">
                    <a href="https://youtu.be/YXsOnmAD1Lg" target="_blank" rel="noopener noreferrer"
                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-600 bg-white border border-gray-200 rounded-full hover:bg-gray-50 hover:text-red-600 hover:border-red-300 transition-colors no-underline">
                    ...
                    <a href="faq.html" target="_blank" rel="noopener noreferrer"
                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-600 bg-white border border-gray-200 rounded-full hover:bg-gray-50 hover:text-indigo-600 hover:border-indigo-300 transition-colors no-underline">
                    ...
                    <a href="https://wa.me/256750470234" target="_blank" rel="noopener noreferrer"
                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-600 bg-white border border-gray-200 rounded-full hover:bg-gray-50 hover:text-green-600 hover:border-green-300 transition-colors no-underline">
